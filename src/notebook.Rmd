...
library(tidyverse)
library(here)
corpus <- open_dataset(here("eetu/data/corpus.parquet")) |> to_duckdb()
metadata <- open_dataset(here("eetu/data/corpus_meta.parquet")) |> to_duckdb()
inferred <- open_dataset(here("eetu/data/corpus_inferred.parquet")) |> to_duckdb()
```
